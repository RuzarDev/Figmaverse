...
const Contact = () => {
  ...
  return (
      <section id="contact" className="py-20 lg:py-32 bg-gray-50" ref={ref}>
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-purple-600 text-white py-4 rounded-lg font-semibold hover:bg-purple-700 transition-colors duration-200 flex items-center justify-center space-x-2"
                >
            ...
            >
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-8">
                  We'd love to hear from you. Whether you have a project in mind or just want to chat about design,
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@figmaverse.com</p>
                  </div>
                </div>
              </div>
